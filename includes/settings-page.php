            ...
            <form method="post" action="options.php">
                <?php
                    // this outputs the
                    settings_fields( 'spp-settings-group' );
                    // This could be moved to a constructor once the plugin is class based
                    do_settings_sections( 'spp-settings-group' );
                ?>
                <table class="form-table">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <label title="Southeast"><input type="radio" name="spp_corner" value="southeast"<?php checked( 'southeast' == get_option('spp_corner') ); ?>> <span>Southeast (bottom right)</span></label><br>
                        </fieldset>
                    </td>
                    </tr>
                    ...
                    <td>
                        <fieldset>
                            ...
                            ?>
                            <label title="Posts"><input type="checkbox" name="spp_pagetype[]" value="posts"<?php checked( in_array('posts', $options) ); ?>> <span>Posts</span></label><br>
                            <label title="Pages"><input type="checkbox" name="spp_pagetype[]" value="pages"<?php checked( in_array('pages', $options) ); ?>> <span>Pages</span></label><br>
                            <label title="Home"><input type="checkbox" name="spp_pagetype[]" value="home"<?php checked( in_array('home', $options) ); ?>> <span>Home</span></label><br>
                            <label title="Archives"><input type="checkbox" name="spp_pagetype[]" value="archives"<?php checked( in_array('archives', $options) ); ?>> <span>Archives</span></label><br>
                            <label title="Search"><input type="checkbox" name="spp_pagetype[]" value="search"<?php checked( in_array('search', $options) ); ?>> <span>Search</span></label><br>
                        </fieldset>
                    </td>
                    </tr>
                    ...
                    <td>
                        ...
                        <fieldset>
                            ...
                            <label title="end of description"><input type="text" class="regular-text" name="spp_description_append" value="<?php echo esc_attr(get_option('spp_description_append')); ?>"></label>
                        </fieldset>
                    </td>
                    </tr>
                </table>
                    ...
                    <table class="form-table">
                        ...
                        <td>
                            <fieldset>
                                ...
                                <label title="Load Async"><input type="radio" name="spp_load" value="async"<?php checked( 'async' == get_option('spp_load') ); ?>> <span>Load pinit.js Asyncronously  (default)</span></label><br>
                                <label title="Do not load Async"><input type="radio" name="spp_load" value="sync"<?php checked( 'sync' == get_option('spp_load') ); ?>> <span>Load pinit.js Syncronously</span></label><br>
                                <label title="Do not load at all"><input type="radio" name="spp_load" value="none"<?php checked( 'none' == get_option('spp_load') ); ?>> <span>Do not load pinit.js (advanced setting; not recommended)</span></label><br>
                            </fieldset>
                        </td>
                        </tr>
                        ...
                        <td>
                            ...
                            <fieldset>
                                ...
                                <label title="Use CSS classes with !important"><input type="checkbox" name="spp_important" value="important"<?php checked( 'important' == get_option('spp_important') ); ?>> <span>Use CSS classes with !important (recommended only if image alignemnt is wrong after install)</span></label><br>
                            </fieldset>
                        </td>
                        </tr>
                        ...
                        <td>
                            ...
                            <fieldset>
                                ...
                                <label title="Do Not Load jQuery"><input type="checkbox" name="spp_load_jq" value="nojquery"<?php checked( 'nojquery' == get_option('spp_load_jq') ); ?>> <span>Do not load jQuery (advanced setting; not recommended)</span></label><br>
                            </fieldset>
                        </td>
                        </tr>
                    </table>
